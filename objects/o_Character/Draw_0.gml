...
switch(character.charName){
	case "Rik":
		...
		if(!character.firstArrival){
			...
			// happy and sober
				if ((character.charHappiness >= (character.charHappinessMax / 2)) && (character.charDrunkennessMax >= (character.charDrunkenness / 2))){
					draw_sprite(s_Rik_happy, 0, x, y);
				}
			// happy and drunk
				else if ((character.charHappiness >= (character.charHappinessMax / 2)) && (character.charDrunkennessMax <= (character.charDrunkenness / 2))){
					draw_sprite(s_Rik_happy, 0, x, y);
				}
			// angry and sober
				else if ((character.charHappiness <= (character.charHappinessMax / 2)) && (character.charDrunkennessMax >= (character.charDrunkenness / 2))){
	...
	case "Quincy":
		draw_healthbar(self.x + 5, self.y + 180, self.x + 175, self.y + 200, min((character.charHappiness/character.charHappinessMax) * 100), c_black, c_red, c_green, 0, true, true);
		if(!character.firstArrival){
	...
	case "Brock":
		draw_healthbar(self.x + 10, self.y + 180, self.x + 184, self.y + 200, min((character.charHappiness/character.charHappinessMax) * 100), c_black, c_red, c_green, 0, true, true);
		if(!character.firstArrival){
	...
	case "Laif":
		draw_healthbar(self.x + 10, self.y + 180, self.x + 110, self.y + 200, min((character.charHappiness/character.charHappinessMax) * 100), c_black, c_red, c_green, 0, true, true);
		if(!character.firstArrival){
