...
function RikDialogueManager(name, happiness, happinessMax, drunkenness, drunkennessMax, firstArrival, drink){
	...
	if(!firstArrival){
		dialogue = ["I have arrived at the bar and want a " + drink, "Here is a choice", ["A","B"], ["You chose A.","You chose B."], "The Dialogue has concluded"];
	}
	else if(firstArrival)
	{
		...
		// happy and drunk text in text box
			...
			conversation1 = ["This is happy drunk dialogue 1 and want a " + drink + ".", "This character is happy drunk.", "Here is a choice", ["A","B"], ["You chose A.","You chose B."], "The Dialogue has concluded", "."];
			conversation2 = ["This is happy drunk dialogue 2 and want a " + drink + ".", "This character is happy drunk.", "Here is a choice", ["A","B"], ["You chose A.","You chose B."], "The Dialogue has concluded", "."];
			conversation3 = ["This is happy drunk dialogue 3 and want a " + drink + ".", "This character is happy drunk.", "Here is a choice", ["A","B"], ["You chose A.","You chose B."], "The Dialogue has concluded", "."];
			randomize();
			dialogue = choose(conversation1, conversation2, conversation3);		
		}
		// angry and sober text in text box
		else if ((happiness <= (happinessMax / 2)) && (drunkenness >= (drunkennessMax / 2))){
			conversation1 = ["This is angry sober dialogue 1 and want a " + drink + ".", "This character is angry sober.", "Here is a choice", ["A","B"], ["You chose A.","You chose B."], "The Dialogue has concluded", "."];
			conversation2 = ["This is angry sober dialogue 2 and want a " + drink + ".", "This character is angry sober.", "Here is a choice", ["A","B"], ["You chose A.","You chose B."], "The Dialogue has concluded", "."];
			conversation3 = ["This is angry sober dialogue 3 and want a " + drink + ".", "This character is angry sober.", "Here is a choice", ["A","B"], ["You chose A.","You chose B."], "The Dialogue has concluded", "."];
			randomize();
			dialogue = choose(conversation1, conversation2, conversation3);	
		}
